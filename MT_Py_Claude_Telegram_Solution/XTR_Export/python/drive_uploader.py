...
zero credentials to manage, and XTR_Export/README.md covers both paths.
...
what an unattended background process needs. See XTR_Export/README.md
...
def build_service(credentials_path: str):
    try:
        ...
        raise RuntimeError(
            ...
            "Drive for Desktop instead (see XTR_Export/README.md)."
        ) from exc
