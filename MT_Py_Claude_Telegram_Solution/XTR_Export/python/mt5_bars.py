"""
Minimal, self-contained MetaTrader 5 wrapper for XTR_Export - deliberately
NOT importing ../../ClaudeSMC_Trader/python/mt5_gateway.py or ../../python/
...
def get_bars(symbol: str, timeframe_name: str, count: int) -> pd.DataFrame:
    ...
    convention as ClaudeSMC_Trader/python/mt5_gateway.get_bars().
    """
    m = mt5()
