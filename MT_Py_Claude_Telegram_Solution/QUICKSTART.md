...
| Trend alignment | No trade against a clearly opposed M15 or H1 trend (Telegram and Claude); a setup that lost twice in the same price range pauses. Lot size, SL and TP are never changed by it |
