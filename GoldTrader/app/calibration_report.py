...
def main(argv: list | None = None) -> int:
    ...
    parser.add_argument("--decisions", default=os.path.join(paths.LOG_DIR, "decisions.csv"))
    parser.add_argument("--trades", default=os.path.join(paths.LOG_DIR, "trades.csv"))
