...
Feeds the three-confluence framework (Trend / Momentum / Strength) - this
module computes the raw numbers, but does NOT pre-judge pass/fail itself. Claude does that
...
docs/REFERENCE.md's "Honest limitations" section.
"""
