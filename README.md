...
- `MQL5/Experts/ClaudeSignalEA.mq5` + `python/claude_signal_bot.py` — a
  separate, experimental file-based pipeline built around the "XTR"
  10-minute XAUUSD micro-scalp spec: the EA exports M1/M5/M15/H1 indicator
  and bar data every minute, and **Claude does the real-time trading
  analysis** — direction, setup rationale, stop and target — informed by
