<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SmartDDRv2.aspx.vb" Inherits="SmarTagsASP.SmartDDRv2" %>
...
<head runat="server">
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .crumb-app { font-size: 13px; opacity: .75; }
        .crumb-sep { opacity: .5; }
        ...
        <aside class="sidebar" aria-label="Reports">
            <div class="brand">
                ...
                <div>
                    ...
                    <div class="brand-sub">Worley &middot; v2</div>
                </div>
            </div>

            <nav class="nav">
                <!-- Portfolio (project group) reports -->
                <div class="nav-section">
                    <label class="nav-label" for="ddlProjectGroup">Portfolio</label>
                ...
                <!-- Aconex reconciliation -->
                <div class="nav-section">
                    <span class="nav-label">Aconex</span>
            ...
            <header class="topbar">
                ...
                <div class="whats-new" id="whatsNew">
                    <asp:Label ID="LblWN" runat="server"
                        Text="What's new: duplicate highlighting · contract-level summaries · Excel (.xlsx) export · click a header to sort · click an M75 count for the document list" />
    ...
    <script>
        (function () {
            ...
            document.addEventListener('keydown', function (e) {
                if (e.key === 'Escape') { closeDrawer(); body.classList.remove('sidebar-open'); return; }
