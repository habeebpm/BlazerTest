...
#Region "View catalogue"
    ...
    Private NotInheritable Class ViewDef
        ...
        Public Sub New(title As String, fileSuffix As String, isGroup As Boolean, hasFooter As Boolean, Optional adminOnly As Boolean = False)
            Me.Title = title
    ...
    Private Shared ReadOnly Views As New Dictionary(Of String, ViewDef)(StringComparer.OrdinalIgnoreCase) From {
        {"G_INFO", New ViewDef("Projects Info", "INFO_ALL", True, True)},
        {"G_M75", New ViewDef("M75 AFC Status (all projects)", "AFC_ALL", True, True)},
        {"G_AFC_IFR", New ViewDef("AFC/IFR Status (all projects)", "AFC_IFR_ALL", True, True)},
        {"G_PLIP", New ViewDef("DDR PLIP Status", "PLIP_STATUS_ALL", True, False)},
        {"G_DDR_ACT", New ViewDef("DDR + Activity (all projects)", "DDR_ACT_ALL", True, False)},
        {"CTD", New ViewDef("Approved CTD", "CTD", False, True)},
        {"CTD_EDIT", New ViewDef("Edit CTD", "CTD_EDIT", False, False, adminOnly:=True)},
        {"DDR_ACT", New ViewDef("DDR + Activity", "DDR_ACT", False, False)},
        {"ACT", New ViewDef("Activities", "ACT", False, True)},
        {"CTD_DDR", New ViewDef("CTD vs DDR", "CTD_DDR_SUMMARY", False, True)},
        {"CTD_DOC", New ViewDef("CTD vs DOC", "CTD_DDR_DOC_HOURS", False, False)},
        {"DUMMY", New ViewDef("Dummy Serials", "DOCNO_DUMMY", False, False)},
        {"DDR_PDO", New ViewDef("DDR Format (PDO)", "DDR_STD", False, False)},
        {"DDR_EPR", New ViewDef("DDR + EPR", "DDREPR", False, True)},
        {"EPR", New ViewDef("EPR", "EPR", False, True)},
        {"M75", New ViewDef("M75 AFC Status", "M75_AFC", False, True)},
        {"AFC_IFR", New ViewDef("AFC/IFR Status", "AFC_IFR", False, True)},
        {"ACON_ALL", New ViewDef("Aconex - All Revisions", "ACON_REF", False, False)},
        {"ACON_LATEST", New ViewDef("Aconex - Latest Revision", "ACON_LATEST_REV", False, False)},
        {"ACON_MISS", New ViewDef("In Aconex, Not in DDR", "DOC_IN_ACONEX_NOT_IN_DDR", False, False)},
        {"DDR_MISSED", New ViewDef("DDR Missed (ready to push)", "TODDR", False, False)}
    }
...
#Region "Page lifecycle"
    ...
    Private Sub InitialLoad()
        ...
        ' Deep links: SmartDDRv2.aspx?project=XXXX&view=M75&disc=...
